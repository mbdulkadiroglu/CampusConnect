...
function FilteredPosts({
  ...
  useEffect(() => {
    ...
    const fetchPosts = async () => {
      try {
        let url = "https://campusconnectbackend-67br.onrender.com/api/post/all/BorrowPost";
        if (searchTerm) {
  ...
  const filteredAndSortedPosts = posts
    ...
    .sort((a, b) => {
      if (sortOption === "durationShortToLong") {
    ...
    <Box sx={{ width: "80%", margin: "0 auto" }}>
      ...
      >
        ...
        <FormControl sx={{ width: "200px" }}>
          ...
          >
            <MenuItem value="durationShortToLong">
              Duration: Short to Long
            </MenuItem>
            <MenuItem value="durationLongToShort">
